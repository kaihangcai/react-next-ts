...
- File: `src/utils/pipeline-state.ts` (NOT runtime code — helper for skills to reference)
- Actually this lives as conventions in the skills themselves:
...
| `.claude/dev-docs/planned-tasks.md` | CREATE | Task registry |
